...
<style type="text/css">
 ...
 <div class="content-wrapper">
  <section class="content-header">
    <?php if($_GET['type'] == 'asm') { ?>
      <h1>Area Sales Update</h1>
    <?php }  ?>
    
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Dashboard</a></li>
          <?php if($_GET['type'] == 'asm') { ?>
        <li class="active">Area Sales Update</li>
  ...
  <section class="content">
    <div class="box">
      <div class="box-header with-border">
        <?php if($_GET['type'] == 'sp') { ?>
          <h3 class="box-title">Area Sales Update</h3>
                            ...
                            <select name="country" id="country"> 
                                 <option value="">SELECT COUNTRY</option> 
                                   <?php $sql1 = mysqli_query($conn, "SELECT * FROM countries WHERE id ='".$country."'");
                                              ...
                                              $country_id = $row1['id']; ?>
                                       <option value="<?php echo $country_id;?>"> <?php echo $country_name;?> </option>                            </select>
                            </div>
                        </div>
                    </div>
                       <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group"> 
                            <div class="col-sm-offset-2 col-sm-10" id="registerForm">
                                <button type="submit" name="ASMUpdate" class="btn btn-success pull-right">Submit</button>
                            </div>
                        </div>
                    </div>
